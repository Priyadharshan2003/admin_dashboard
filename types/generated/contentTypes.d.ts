...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    personal_details: Schema.Attribute.Component<
      'user-profile-details.client-profile',
      true
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiGuestGuest extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::guest.guest'> &
      Schema.Attribute.Private;
    otp_verified: Schema.Attribute.Boolean;
    personal_details: Schema.Attribute.Component<
      'user-profile-details.guest-profile',
      true
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_created_at: Schema.Attribute.DateTime;
...
export interface ApiManagerManager extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    personal_details: Schema.Attribute.Component<
      'user-profile-details.manager-profile',
      false
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiPlotPlot extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    facing: Schema.Attribute.Enumeration<['East', 'West', 'North', 'South']>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    stats: Schema.Attribute.Enumeration<['Available', 'Sold', 'Advance']>;
...
export interface ApiUserListUserList extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    picture: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'https://i.pinimg.com/736x/36/50/2d/36502d663186cfbf03b14d399aacbf22.jpg'>;
    publishedAt: Schema.Attribute.DateTime;
    roles: Schema.Attribute.Enumeration<['guest', 'client', 'manager']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
